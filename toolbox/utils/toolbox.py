...
def runStats() -> str:
    ...
    remote_shard_0 = [f'/home/{validatorToolbox.activeUserName}/harmony/hmy', 'blockchain', 'latest-headers', f'--node=https://api.s0.t.hmny.io']
    ...
    remote_shard = [f'/home/{validatorToolbox.activeUserName}/harmony/hmy', 'blockchain', 'latest-headers', f'--node=https://api.s{ourShard}.t.hmny.io']
    ...
    local_shard = [f'/home/{validatorToolbox.activeUserName}/harmony/hmy', 'blockchain', 'latest-headers']
