...
def harmony_voting() -> None:
    ...
    if question:
        ...
        process_command(
            f"{EnvironmentVariables.hmy_app} governance vote-proposal --space harmony-mainnet.eth --proposal 0xce5f516c683170e4164a06e42dcd487681f46f42606b639955eb7c0fa3b13b96 --proposal-type single-choice --choice {vote_choice_option} --key {validator_wallet_name} --passphrase",
            True,
            True,
        )
    return
