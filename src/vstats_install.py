...
def install_vstats(vstatsToken) -> None:
    ...
    update_text_file(f"{easy_env.user_home_dir}/harmony_node_stats/config.py", 'VSTATS_TOKEN=""', f'VSTATS_TOKEN="{vstatsToken}"')
    if os.path.isdir(f"{easy_env.user_home_dir}/harmony"):
        update_text_file(f"{easy_env.user_home_dir}/harmony_node_stats/config.py", '"harmony_folder":"/home/serviceharmony/harmony"', f'"harmony_folder":"{easy_env.user_home_dir}/harmony"')
    else:
        if os.path.isfile(f"{easy_env.user_home_dir}/harmony"):
            update_text_file(f"{easy_env.user_home_dir}/harmony_node_stats/config.py", '"harmony_folder":"/home/serviceharmony/harmony"', f'"harmony_folder":"{easy_env.user_home_dir}"')
