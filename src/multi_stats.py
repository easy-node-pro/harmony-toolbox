...
def stats_output_regular(folders) -> None:
    ...
    # Print Menu
    print_stars()
    print(f'{Fore.GREEN}* validator-toolbox for {Fore.CYAN}Harmony ONE{Fore.GREEN} Validators by Easy Node   v{easy_env.easy_version}{Style.RESET_ALL}{Fore.WHITE}   https://easynode.pro {Fore.GREEN}*')
    print_stars()
